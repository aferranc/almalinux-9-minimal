...
<comps>
  <group>
    ...
    <name xml:lang="it_IT">Strumenti Anaconda</name>
    ...
    <packagelist>
      ...
      <packagereq type="mandatory">cryptsetup-libs</packagereq>
  ...
  <group>
    ...
    <description xml:lang="af_ZA">Kleinste moontlike installasie</description>
    ...
    <description xml:lang="es_ES">Instalación lo más pequeña posible</description>
    ...
    <description xml:lang="hr_HR">Najmanja moguća instalacija</description>
    ...
    <description xml:lang="it_IT">Installazione minima</description>
    ...
    <description xml:lang="ms_MY">Pemasangan sekecil mungkin</description>
    ...
    <description xml:lang="ru_RU">Минимальная установка</description>
    ...
    <description xml:lang="ta_IN">மிக சிறிய நிறுவல்</description>
    ...
    <packagelist>
      ...
      <packagereq type="mandatory">coreutils-common</packagereq>
      ...
      <packagereq type="mandatory">kernel-core</packagereq>
      <packagereq type="mandatory">kernel-modules</packagereq>
  ...
  <environment>
    ...
    <name xml:lang="ta_IN">குறைந்தபட்ச நிறுவல்</name>
    <name xml:lang="te">కనీసపు సంస్థాపన</name>
    <name xml:lang="uk">Мінімальна система</name>
    <name xml:lang="uk_UA">Мінімальна система</name>
    ...
    <description xml:lang="ta_IN">அடிப்படை செயலம்சம்.</description>
    <description xml:lang="te">ప్రాథమిక ఫంక్షనాలిటి.</description>
    <description xml:lang="uk">Основні можливості.</description>
    <description xml:lang="uk_UA">Основні можливості.</description>
